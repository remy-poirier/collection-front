...
interface Props extends Pick<User, "totalValue"> {}

export const UserCollectionChart = ({totalValue}: Props) => {

  if(Object.keys(totalValue).length < 2) {
    return (
  ...
  const chartData = Common.buildChartData(totalValue)
